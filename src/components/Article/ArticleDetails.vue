        ...
        <n-gi :offset="ngiOffsetValue" :span="ngiSpanValue">
          <n-card>
            ...
            <div :id="isdarkTheme ? 'darkEditor' : ''" style="min-height: 50vh">
              <MdPreview :theme="isdarkTheme ? 'dark' : 'light'" v-model="articlesInfo.articleContent" />
            </div>
            <template #footer>
              <n-divider />
              <!--             切换主题-->
...
const get_ArticlesById = () => {
  ...
  articlesInfo.value = {
    articleContent: `# 测试 <br/> ![](https://qiyuan-cloud-data.oss-cn-guangzhou.aliyuncs.com/pinkavatar.jpg) <br/>## 标题`,
