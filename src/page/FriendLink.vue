<template>
  <BackgroundPlate title="友情链接" description="人有没有钱是看不出来的,当我们在街上擦肩而过的时候,你绝不会想到我竟然是超级会员?" color="#1976d2">
  </BackgroundPlate>
  <n-grid :cols="8">
    <n-gi style="min-height: 100vh" :offset="clientWidth > 1075 ? 1 : 0" :span="clientWidth > 1075 ? 6 : 8">
      <n-card :embedded="isdarkTheme" :bordered="!isdarkTheme">
        ...
        <n-text tag="div"> 名称：Helloqiyuan</n-text>
        <n-text tag="div"> 网址：http://ys.ruolin.site/</n-text>
        <n-text tag="div"> 图标：https://qiyuan-cloud-data.oss-cn-guangzhou.aliyuncs.com/pinkavatar.jpg</n-text>
  ...
  <n-modal :mask-closable="false" v-model:show="addlinkShowModal">
    <n-card :style="{ 'width': clientWidth > 1025 ? '500px' : '96%' }" title="友链信息填写" :bordered="false" size="huge"
...
const get_LinksAll = () => {
  linkList.value = [{
    linkLink: 'http://ys.ruolin.site/',
    linkIcon: 'https://qiyuan-cloud-data.oss-cn-guangzhou.aliyuncs.com/pinkavatar.jpg',
    linkName: '张苹果',
